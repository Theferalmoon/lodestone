...
- **Production audit status** — `pnpm audit --prod` is clean as of the v0.1.10 friend-install release prep on 2026-06-13. Registry advisories can change, so rerun the audit as a live check before strict security signoff.

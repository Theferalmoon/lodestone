...
- **Production audit clean at v0.1.5 prep.** `pnpm audit --prod` is clean as of 2026-06-08 after patched transitive overrides. Registry advisories can change, so strict environments should rerun the audit during intake.
...
|---|---|---|---|
| **Lodestone** (this) | C | v0.1.5 friend install | Single-KG per-project package set. Privacy-first. The local sidecar. |

...
- **Production audit clean at v0.1.12 prep.** `pnpm audit --prod` is clean as of 2026-06-13 after patched transitive overrides. Registry advisories can change, so strict environments should rerun the audit during intake.
...
|---|---|---|---|
| **Lodestone** (this) | C | v0.1.12 friend install | Single-KG per-project package set. Privacy-first. The local sidecar. |

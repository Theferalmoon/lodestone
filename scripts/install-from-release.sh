...
#   curl -sSfL https://lodestone.cmndi.ai/install | LODESTONE_VERSION=v0.1.15 LODESTONE_PROFILE=lite bash
#
...
#
# What it does:
#   1. Resolves the version (env LODESTONE_VERSION, default v0.1.15).
...
#
# Disk footprint (lite profile verified e2e 2026-06-13 against v0.1.15 on Node 22;
...
LODESTONE_VERSION="${LODESTONE_VERSION:-v0.1.15}"
...
expected_sha256() {
  ...
  case "$tag:$file" in
    ...
    v0.1.14:lodestone-ingest-0.1.14-lite.tgz) printf '%s\n' "e020eba80ce07f23db6afe51032677f1c808268f63576566b682f6a74da8d496" ;;
    v0.1.14:lodestone-ingest-0.1.14-full.tgz) printf '%s\n' "73a5c7c7ca7fc02ff516ec6ab17026a0fedfcbe5622282032e755fddf799e1ec" ;;
    ...
    v0.1.12:lodestone-ingest-0.1.12-lite.tgz) printf '%s\n' "379ab8420f78f00ae2271980574fe87f9a8c23bd3a6f35935cb5f39b51929e24" ;;
    v0.1.12:lodestone-ingest-0.1.12-full.tgz) printf '%s\n' "86c670ee723b441367f1c78388adfb4569e969ad90917751122bd420c1f45a16" ;;
...
if [[ "$LODESTONE_VERSION" == "latest" ]]; then
  fail "this pinned friend installer does not support LODESTONE_VERSION=latest; use LODESTONE_VERSION=v0.1.15 or fetch a newer installer"
else

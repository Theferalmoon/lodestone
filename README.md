...
**Pinning.** The friend installer defaults to the approved `v0.1.8` package set. To make that explicit:

```bash
curl -sSfL https://lodestone.cmndi.ai/install | LODESTONE_VERSION=v0.1.8 bash
```
